...
especie varchar(45),
fkDados int,
foreign key fkDadosSensores (fkDados) references DadosSensores (idDadosSensores)
);
...
insert into Estufas (NomeEstufa, fkCadastroCogumelo, fkCadastroEmpresa) values
('EstufaShitake', 1, 1),
('EstufaShimeji', 2, 2),
